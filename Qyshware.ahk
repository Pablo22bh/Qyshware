...
{
	MouseGetPos, xm, ym
	ToolTip, Checking Script Status.., %x%, %y%
	URLDownloadToFile, https://pastebin.com/raw/mBuYyjbP, C:\Users\%A_UserName%\check.txt
	FileSetAttrib, +H, C:\Users\%A_UserName%\check.txt
	Sleep, 2000
	FileRead, check, C:\Users\%A_UserName%\check.txt
	Sleep, 1000
	if(check == "2")
	{
		ToolTip
		MsgBox, 16, Cheat Status, There is an Update! Do you want to open the Thread page?
		IfMsgBox, Yes
		{
			Run, https://www.unknowncheats.me/forum/cs-go-releases/265379-ahk-external-aimbot-triggerbot-lessrecoil-drag-source.html#post20375722
		}
		ExitApp
		return
	}
	...
	{
		ToolTip
		MsgBox, 16, Cheat Status, The Cheat is currently offline.
		ExitApp
		return
	}
	else if(check == "1")
	...
	else if(check != "0" and check != "1" and check != "2" and )
	{
		ToolTip
		MsgBox, 16, Cheat Status, Cant check status! Do you want to open the Thread page?
		IfMsgBox, Yes
		{
			Run, https://www.unknowncheats.me/forum/cs-go-releases/265379-ahk-external-aimbot-triggerbot-lessrecoil-drag-source.html#post2037572
		}
		IfMsgBox, No
		{
			ExitApp
...
AimbotHelp:
	...
	IfMsgBox, Yes
	{
		Run, https://hastebin.com/qemumiduyi.vbs
	}
return
...
MsgBox, 36, Triggerbot Help, Do you want to open the Help page?
	IfMsgBox, Yes
	{
		Run, https://hastebin.com/aqeririxeg.pl
	}
return
